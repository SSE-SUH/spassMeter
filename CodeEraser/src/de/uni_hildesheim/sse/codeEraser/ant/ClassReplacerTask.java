...
import de.uni_hildesheim.sse.codeEraser.replace.CodeProcessor;
import de.uni_hildesheim.sse.codeEraser.replace.Configuration;

/**
 * Implements the class replacer task.
 * 
 * @author Holger Eichelberger
 * @since 1.00
 * @version 1.00
 */
public class ClassReplacerTask extends AbstractTask {
    ...
    public void execute() throws BuildException {
        ...
        for (Mapping mapping : mappings) {
            if (mapping.isPattern()) {
                conf.addPattern(mapping.getOldName(), mapping.getNewName());
            } else {
