...
public class ProcessorDataGatherer implements IProcessorDataGatherer {

	/**
	 * Returns the number of processors.
	 * 
	 * @return the number of processors (negative or zero if invalid)
	 * 
	 * @since 1.00
	 */
	 ...
	 * 
	 * @return the maximum physical speed of the processor(s) in Hertz (negative
	 *         or zero if invalid)
	 * 
	 * @since 1.00
	 */
	 ...
	 * 
	 * @return the current load in percent (0-100) (negative or zero if invalid)
	 * 
	 * @since 1.00
	 */
	@Variability(id = AnnotationConstants.VAR_PROCESSOR_DATA, value = "-1")
