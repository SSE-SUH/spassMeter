...
public class IntHashMap<T> extends AbstractIntHashMap {
     ...
     * The IntHashMap is created with default load factor and an initial 
     * capacity sufficient to hold the mappings in the specified Map.
     * 
     * @param map The map whose mappings are to be placed in this map. 
     * @throws NullPointerException if the specified map is <code>null</code>.
     */
    public IntHashMap(IntHashMap<T> map) {
        super(map);
    }
    ...
    @Override
    public void putAll(AbstractIntHashMap map) {
        IntHashMap<T> lMap = (IntHashMap<T>) map;
        int[] keys = map.keySet();
    ...
    */
    ...
    @SuppressWarnings("unchecked")
    @Override
    protected IntHashMap.MapElement<T> create(int key, Object value) {
