...
/**
 * An abstract hash map for mapping int values. This class does not specify
...
public abstract class AbstractIntHashMap {
    ...
    */
    public AbstractIntHashMap(int initialCapacity, float loadFactor) {
    ...
    */
     ...
     * @since 1.00
     */
    protected MapElement create(int key, Object value) {
