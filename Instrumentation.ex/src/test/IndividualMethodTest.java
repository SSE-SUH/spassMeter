...
public class IndividualMethodTest {
     ...
     * @since 1.00
     */
    @Monitor(id = AnnotationId.ID_INDIVIDUALMETHOD)
    ...
    private static void execute() {
        IndividualMethodTest instance = new IndividualMethodTest();
        instance.testMemory();
    ...
    public static void main(String[] args) {
        TestEnvironment.notice(IndividualMethodTest.class.getName());
        if (args.length > 0) {
        ...
        TestEnvironment.notice("------------------ done: IndividualMethod");
    }
    ...
    public static void asserts() {
        ...
        // noting happens in this monitoring group... except of some processing
        TestEnvironment.assertEquals(AnnotationId.ID_INDIVIDUALMETHOD, 
        ...
        // no assert about CPU_TIME as waiting in one method does not 
        // consume much / is below OS resolution 
        TestEnvironment.assertGreater(AnnotationId.ID_INDIVIDUALMETHOD, 
            MonitoringGroupValue.SYSTEM_TIME, 
            (long) (0.95 * WAIT_TIME * WAIT_MAX * 1000 * 1000));
        // 95% is sufficient as waiting is not fully precise
        ...
        TestEnvironment.success(AnnotationId.ID_INDIVIDUALMETHOD);
    }
