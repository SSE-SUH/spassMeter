...
public class InstanceIdentifierTest {
     ...
     * @since 1.00
     */
    @Monitor(id = "exec", instanceIdentifierKind = InstanceIdentifierKind.IDENTITY_HASHCODE)
    ...
    public static void main(String[] args) {
        ...
        TestEnvironment.notice(InstanceIdentifierTest.class.getName());
        InstanceIdentifierTest test = new InstanceIdentifierTest();
        if (args.length > 0) {
        ...
        TestEnvironment.notice("------------------ done: InstanceIdentifierTest");
    ...
    public static void asserts() {
        String recId = InstanceIdentifierTest.class.getName();
        
        String[] ids = TestEnvironment.getInstanceIdentifiers("exec");
        TestEnvironment.assertNotNull(recId, ids);
        TestEnvironment.assertEquals(recId, ids.length, 1);
        String instanceId = ids[0];
        
        TestEnvironment.assertEquals(recId, TestEnvironment.getValue("exec", MonitoringGroupValue.CPU_TIME), 
            TestEnvironment.getValue(instanceId, MonitoringGroupValue.CPU_TIME));
