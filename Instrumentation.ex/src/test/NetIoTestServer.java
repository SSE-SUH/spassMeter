...
public class NetIoTestServer extends AbstractNetIoTest {
     ...
     * @version 1.00
     */
    @Monitor(id = AnnotationId.ID_NET_IO_SERVER)
    ...
    public static void main(String[] args) throws IOException {
        AbstractNetIoTest.main(args, new NetIoTestServer());
    }
    ...
    public static void asserts() {
        // client resources without server are accounted to ID_NET_IO
        ...
        // server resources without client are accounted to ID_NET_IO_SERVER
        TestEnvironment.assertEquals(AnnotationId.ID_NET_IO_SERVER, 
            MonitoringGroupValue.NET_WRITE, AbstractNetIoTest.getServerWrite());
        TestEnvironment.assertEquals(AnnotationId.ID_NET_IO_SERVER, 
            MonitoringGroupValue.NET_READ, AbstractNetIoTest.getServerRead());
