...
#ifdef VAR_WIFI_DATA  
extern "C" JNIEXPORT jobjectArray JNICALL Java_de_uni_1hildesheim_sse_system_android_DataGatherer_gatherWifiSignals0
...
extern "C" JNIEXPORT jint JNICALL Java_de_uni_1hildesheim_sse_system_android_ScreenDataGatherer_getScreenWidth0
  (JNIEnv *env, jclass c) {
    return getScreenWidth();
}

extern "C" JNIEXPORT jint JNICALL Java_de_uni_1hildesheim_sse_system_android_ScreenDataGatherer_getScreenHeight0
  (JNIEnv *env, jclass c) {
    return getScreenHeight();
}

extern "C" JNIEXPORT jint JNICALL Java_de_uni_1hildesheim_sse_system_android_ScreenDataGatherer_getScreenResolution0
  (JNIEnv *env, jclass c) {
...
extern "C" JNIEXPORT jlong JNICALL Java_de_uni_1hildesheim_sse_system_android_MemoryDataGatherer_getMemoryCapacity0
  (JNIEnv *env, jclass c) {
   return getMemoryCapacity();
}

extern "C" JNIEXPORT jlong JNICALL Java_de_uni_1hildesheim_sse_system_android_MemoryDataGatherer_getCurrentMemoryAvail0
  (JNIEnv *env, jclass c) {
    return getCurrentMemoryAvail();
}

extern "C" JNIEXPORT jlong JNICALL Java_de_uni_1hildesheim_sse_system_android_MemoryDataGatherer_getCurrentMemoryUse0
  (JNIEnv *env, jclass c) {
    return getCurrentMemoryUse();
}

// all in one, be careful
extern "C" JNIEXPORT jint JNICALL Java_de_uni_1hildesheim_sse_system_android_DataGatherer_redefineMultiClasses0
...
extern "C" JNIEXPORT jint JNICALL Java_de_uni_1hildesheim_sse_system_android_DataGatherer_redefineClasses0
  (JNIEnv *env, jclass c, jobjectArray classes, jobjectArray bytecode) {
	jint status = -1;
#if defined(WITH_JVMTI)
    jsize cCount = env->GetArrayLength(classes);
...
// just one
extern "C" JNIEXPORT jint JNICALL Java_de_uni_1hildesheim_sse_system_android_DataGatherer_redefineClass0
...
extern "C" JNIEXPORT void JNICALL Java_de_uni_1hildesheim_sse_system_android_MemoryDataGatherer_recordUnallocation0
...
extern "C" JNIEXPORT void JNICALL Java_de_uni_1hildesheim_sse_system_android_MemoryDataGatherer_recordUnallocation2
  (JNIEnv *env, jclass c, jlong tag, jlong size, jint recId)  {
    storeUnallocationInfoTag(tag, size, recId);
}

extern "C" JNIEXPORT void JNICALL Java_de_uni_1hildesheim_sse_system_android_MemoryDataGatherer_recordUnallocation4
  (JNIEnv *env, jclass c, jlong tag)  {
	unallocate(tag);
}


extern "C" JNIEXPORT void JNICALL Java_de_uni_1hildesheim_sse_system_android_MemoryDataGatherer_receiveUnallocations0
...
extern "C" JNIEXPORT jlong JNICALL Java_de_uni_1hildesheim_sse_system_android_MemoryDataGatherer_getObjectSize0
...
extern "C" JNIEXPORT jboolean JNICALL Java_de_uni_1hildesheim_sse_system_android_DataGatherer_supportsJVMTI0
  (JNIEnv * env, jclass c) {
     #ifdef WITH_JVMTI
	 return (0 != jvmti);
	 #else
...
extern "C" JNIEXPORT jint JNICALL Java_de_uni_1hildesheim_sse_system_android_ProcessorDataGatherer_getNumberOfProcessors0
  (JNIEnv *env, jclass c) {
    return getNumberOfProcessors();
}

extern "C" JNIEXPORT jint JNICALL Java_de_uni_1hildesheim_sse_system_android_ProcessorDataGatherer_getMaxProcessorSpeed0
  (JNIEnv *env, jclass c) {
    return getMaxProcessorSpeed();
}

extern "C" JNIEXPORT jint JNICALL Java_de_uni_1hildesheim_sse_system_android_ProcessorDataGatherer_getCurrentProcessorSpeed0
  (JNIEnv *env, jclass c) {
    return  getCurrentProcessorSpeed();
}

extern "C" JNIEXPORT double JNICALL Java_de_uni_1hildesheim_sse_system_android_ProcessorDataGatherer_getCurrentSystemLoad0
  (JNIEnv *env, jclass c) {
...
extern "C" JNIEXPORT jlong JNICALL Java_de_uni_1hildesheim_sse_system_android_VolumeDataGatherer_getVolumeCapacity0
  (JNIEnv *env, jclass c) {
    return getVolumeCapacity();
}

extern "C" JNIEXPORT jlong JNICALL Java_de_uni_1hildesheim_sse_system_android_VolumeDataGatherer_getCurrentVolumeAvail0
  (JNIEnv *env, jclass c) {
    return getCurrentVolumeAvail();
}

extern "C" JNIEXPORT jlong JNICALL Java_de_uni_1hildesheim_sse_system_android_VolumeDataGatherer_getCurrentVolumeUse0
  (JNIEnv *env, jclass c) {
...
extern "C" JNIEXPORT jlong JNICALL Java_de_uni_1hildesheim_sse_system_android_NetworkDataGatherer_getCurrentNetSpeed0
  (JNIEnv *env, jclass c) {
    return getCurrentNetSpeed();
}

extern "C" JNIEXPORT jlong JNICALL Java_de_uni_1hildesheim_sse_system_android_NetworkDataGatherer_getMaxNetSpeed0
  (JNIEnv *env, jclass c) {
...
extern "C" JNIEXPORT jboolean JNICALL Java_de_uni_1hildesheim_sse_system_android_BatteryDataGatherer_hasSystemBattery0
  (JNIEnv *env, jclass c) {
    return hasSystemBattery();
}

extern "C" JNIEXPORT jint JNICALL Java_de_uni_1hildesheim_sse_system_android_BatteryDataGatherer_getBatteryLifePercent0
  (JNIEnv *env, jclass c) {
    return getBatteryLifePercent();
}

extern "C" JNIEXPORT jint JNICALL Java_de_uni_1hildesheim_sse_system_android_BatteryDataGatherer_getBatteryLifeTime0
  (JNIEnv *env, jclass c) {
    return getBatteryLifeTime();
}

extern "C" JNIEXPORT jint JNICALL Java_de_uni_1hildesheim_sse_system_android_BatteryDataGatherer_getPowerPlugStatus0
  (JNIEnv *env, jclass c) {
...
extern "C" JNIEXPORT jstring JNICALL Java_de_uni_1hildesheim_sse_system_android_ThisProcessDataGatherer_getCurrentProcessID0
  (JNIEnv *env, jclass c) {
	char buf[20];
...
#ifdef VAR_IO_DATA
extern "C" JNIEXPORT jobject JNICALL Java_de_uni_1hildesheim_sse_system_android_ThisProcessDataGatherer_getCurrentProcessIo0
  (JNIEnv *env, jclass c) {
...
#ifdef VAR_MEMORY_DATA
extern "C" JNIEXPORT jlong JNICALL Java_de_uni_1hildesheim_sse_system_android_ThisProcessDataGatherer_getCurrentProcessMemoryUse0
  (JNIEnv *env, jclass c) {
...
#ifdef VAR_TIME_DATA
extern "C" JNIEXPORT jlong JNICALL Java_de_uni_1hildesheim_sse_system_android_ThisProcessDataGatherer_getCurrentProcessUserTimeTicks0
  (JNIEnv *env, jclass c) {
    return getCurrentProcessUserTimeTicks();
}

extern "C" JNIEXPORT jlong JNICALL Java_de_uni_1hildesheim_sse_system_android_ThisProcessDataGatherer_getCurrentProcessKernelTimeTicks0
  (JNIEnv *env, jclass c) {
    return getCurrentProcessKernelTimeTicks();
}

extern "C" JNIEXPORT jlong JNICALL Java_de_uni_1hildesheim_sse_system_android_ThisProcessDataGatherer_getCurrentProcessSystemTimeTicks0
  (JNIEnv *env, jclass c) {
    return getCurrentProcessSystemTimeTicks();
}

/*
extern "C" JNIEXPORT jlong Java_de_uni_1hildesheim_sse_system_android_ThisProcessDataGatherer_getCurrentProcessCycleTimeTicks0
  (JNIEnv *env, jclass c) {
    return getCurrentProcessSystemTimeTicks();
}*/
#endif
...
#ifdef VAR_LOAD_DATA
extern "C" JNIEXPORT jdouble Java_de_uni_1hildesheim_sse_system_android_ThisProcessDataGatherer_getCurrentProcessProcessorLoad0
  (JNIEnv *env, jclass c) {
...
/*#ifdef VAR_DEBUG
extern "C" JNIEXPORT jlong Java_de_uni_1hildesheim_sse_system_android_DataGatherer_getLastError
  (JNIEnv *env, jclass c) {
    #ifdef _WINDOWS
    return GetLastError();
	#else
...
extern "C" JNIEXPORT jlong JNICALL Java_de_uni_1hildesheim_sse_system_android_DataGatherer_getLastLoadError
  (JNIEnv *env, jclass c) {
...
extern "C" JNIEXPORT jboolean JNICALL Java_de_uni_1hildesheim_sse_system_android_ProcessDataGatherer_isProcessAlive0
  (JNIEnv *env, jclass c, jint pid) {
	return isProcessAlive(pid);
}

#ifdef VAR_IO_DATA
extern "C" JNIEXPORT jobject JNICALL Java_de_uni_1hildesheim_sse_system_android_ProcessDataGatherer_getProcessIo0
  (JNIEnv *env, jclass c, jint pid) {
...
#ifdef VAR_MEMORY_DATA
extern "C" JNIEXPORT jlong JNICALL Java_de_uni_1hildesheim_sse_system_android_ProcessDataGatherer_getProcessMemoryUse0
  (JNIEnv *env, jclass c, jint pid) {
...
#ifdef VAR_TIME_DATA
extern "C" JNIEXPORT jlong JNICALL Java_de_uni_1hildesheim_sse_system_android_ProcessDataGatherer_getProcessUserTimeTicks0
  (JNIEnv *env, jclass c, jint pid) {
    return getProcessUserTimeTicks(pid);
}

extern "C" JNIEXPORT jlong JNICALL Java_de_uni_1hildesheim_sse_system_android_ProcessDataGatherer_getProcessKernelTimeTicks0
  (JNIEnv *env, jclass c, jint pid) {
    return getProcessKernelTimeTicks(pid);
}

extern "C" JNIEXPORT jlong JNICALL Java_de_uni_1hildesheim_sse_system_android_ProcessDataGatherer_getProcessSystemTimeTicks0
  (JNIEnv *env, jclass c, jint pid) {
...
#ifdef VAR_LOAD_DATA
extern "C" JNIEXPORT jdouble Java_de_uni_1hildesheim_sse_system_android_ProcessDataGatherer_getProcessProcessorLoad0
  (JNIEnv *env, jclass c, jint pid) {
...
#ifdef VAR_IO_DATA
extern "C" JNIEXPORT jobject JNICALL Java_de_uni_1hildesheim_sse_system_android_ThisProcessDataGatherer_getAllProcessesIo0
  (JNIEnv *env, jclass c) {
    return toJavaIoStatistics(env, getAllProcessesIo());
}

extern "C" JNIEXPORT jobject Java_de_uni_1hildesheim_sse_system_android_ProcessDataGatherer_getAllProcessesIo0
  (JNIEnv *env, jclass c) {
    return toJavaIoStatistics(env, getAllProcessesIo());
}
#ifdef VAR_ARBITRARY_PROCESS_DATA
extern "C" JNIEXPORT jboolean JNICALL Java_de_uni_1hildesheim_sse_system_android_ProcessDataGatherer_isNetworkIoDataIncluded0
  (JNIEnv *, jclass c, jboolean forAll) {
	return isNetworkIoDataIncluded(forAll);
}
extern "C" JNIEXPORT jboolean JNICALL Java_de_uni_1hildesheim_sse_system_android_ProcessDataGatherer_isFileIoDataIncluded0
  (JNIEnv *, jclass c, jboolean forAll) {
	return isFileIoDataIncluded(forAll);
}
#endif
#ifdef VAR_CURRENT_PROCESS_DATA
extern "C" JNIEXPORT jboolean JNICALL Java_de_uni_1hildesheim_sse_system_android_ThisProcessDataGatherer_isNetworkIoDataIncluded0
  (JNIEnv *, jclass c, jboolean forAll) {
	return isNetworkIoDataIncluded(forAll);
}
extern "C" JNIEXPORT jboolean JNICALL Java_de_uni_1hildesheim_sse_system_android_ThisProcessDataGatherer_isFileIoDataIncluded0
  (JNIEnv *, jclass c, jboolean forAll) {
	return isFileIoDataIncluded(forAll);
}
#endif
...
#ifdef ANDROID
extern "C" JNIEXPORT jboolean JNICALL Java_de_uni_1hildesheim_sse_system_android_ThreadDataGatherer_supportsCpuThreadTiming0
  (JNIEnv *, jclass) {
	return supportsCpuThreadTiming();
}
extern "C" JNIEXPORT jlong JNICALL Java_de_uni_1hildesheim_sse_system_android_ThreadDataGatherer_getCpuThreadTime0
  (JNIEnv *, jclass, jlong threadId) {
	return getCpuThreadTime(threadId);
}
extern "C" JNIEXPORT void JNICALL Java_de_uni_1hildesheim_sse_system_android_DataGatherer_registerThread0
